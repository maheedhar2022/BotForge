...
// lucide-react v3 removed social brand icons — use inline SVGs instead
function IconX({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.742l7.727-8.836L1.254 2.25H8.08l4.261 5.632 5.903-5.632Zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
    </svg>
  );
}
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm text-slate-500 leading-relaxed mb-6 max-w-xs">
              Deploy AI-powered chatbots on your website in minutes. 24/7 customer support, lead capture, and more.
            </p>
            <div className="flex items-center gap-3">
              {[
                { icon: <IconX size={16} />,        href: '#', label: 'X (Twitter)' },
                { icon: <IconGithub size={16} />,   href: '#', label: 'GitHub' },
        ...
        <div className="border-t border-white/8 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-600">
            © {new Date().getFullYear()} BotForge, Inc. All rights reserved.
          </p>
          <p className="text-sm text-slate-600">
